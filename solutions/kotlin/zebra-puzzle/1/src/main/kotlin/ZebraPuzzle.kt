class ZebraPuzzle() {
    ...
    fun drinksWater(): String = houses.first { 
        it.drink == Drink.WATER 
    }.nation.toString().lowercase().capitalize()
  
    fun ownsZebra(): String = houses.first { 
        it.pet == Pet.ZEBRA 
    }.nation.toString().lowercase().capitalize()
    ...
    fun solvePuzzle(): List<State> {
        ...
        */
        ...
        val colorNationPairs = validColorPermutations.flatMap { colors ->
                ...
                .map { nations -> colors to nations }
            }

        val colorDrinkNationState: List<State> = colorNationPairs.flatMap { (colors, nations) ->
